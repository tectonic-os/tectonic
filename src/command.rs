...
pub const COMMANDS: &[Spec] = &[
    ...
    Spec {
        ...
        noun: "key",
        arg: "<kind>",
        about: "record a key you already hold, in place of generating one",
        family: Family::Repo,
        host: false,
        takes: &["root", "module", "from"],
    },
    Spec {
        verb: Verb::Check,
        word: "check",
    ...
    Spec {
        ...
        noun: "rules",
        arg: "<number>...",
        about: "print the rule each benchmark number reaches, one per line",
        family: Family::Script,
        host: true,
        takes: &["datastream"],
    },
    Spec {
        verb: Verb::ScapTailoring,
        word: "scap",
        noun: "tailoring",
        arg: "",
        about: "print the tailoring the target is scanned with",
        family: Family::Script,
        host: false,
        takes: &["root", "target", "datastream"],
    },
    Spec {
        verb: Verb::Scap,
        word: "scap",
    ...
    Spec {
        ...
        noun: "",
        arg: "",
        about: "print the installer recipe one target installs from",
        family: Family::Script,
        host: false,
        takes: &["root", "target", "tag", "image"],
    },
    Spec {
        verb: Verb::OsRelease,
        word: "os-release",
