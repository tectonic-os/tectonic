...
and the ones that need a repository. Every one of them is in that list now that
the installer is its own binary, documented in its own repository. The two
